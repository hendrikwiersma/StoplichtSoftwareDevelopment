...
public class ClientConnect2 : MonoBehaviour {
/*	public string ipaddress;
	...
	void Start () {
		...
		try {
			...
			System.Net.IPEndPoint endPoint = new System.Net.IPEndPoint (System.Net.IPAddress.Parse (ipaddress), 10000);
			clientSocket = new Socket (AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
			print("Client Started at " + ipaddress);
	...
	void Update () {
		if (clientSocket != null) {
			...
			int bytesRead = clientSocket.Receive(inStream);
